...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 04, 2025 at 07:30 AM
...
CREATE TABLE `inventory_history` (
  ...
  `inventory_id` int(11) NOT NULL,
  `transaction_type` enum('BULK_IMPORT','MANUAL_ADD','MANUAL_DEDUCT','SALE','RETURN','ADJUSTMENT') NOT NULL,
  `quantity` int(11) NOT NULL,
...
--
-- Table structure for table `product_sales_analysis`
--
...
CREATE TABLE `product_sales_analysis` (
  ...
  `total_quantity_sold` decimal(32,0) DEFAULT NULL,
  `total_revenue` decimal(32,2) DEFAULT NULL,
  `average_price` decimal(14,6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `product_total_stock`
--
...
--
-- Table structure for table `returns_analysis`
--
...
CREATE TABLE `returns_analysis` (
  ...
  `branch_id` int(11) DEFAULT NULL,
  `branch_name` varchar(100) DEFAULT NULL,
  `total_returns` bigint(21) DEFAULT NULL,
  `total_return_amount` decimal(32,2) DEFAULT NULL,
...
--
-- Table structure for table `supplier_archives`
--

CREATE TABLE `supplier_archives` (
  `archive_id` int(11) NOT NULL,
  `supplier_id` int(11) NOT NULL,
...
ALTER TABLE `inventory_history`
  ...
  ADD KEY `fk_inventory_history_user` (`created_by`);
...
--
-- Indexes for table `supplier_archives`
--
ALTER TABLE `supplier_archives`
  ADD PRIMARY KEY (`archive_id`),
  ADD KEY `supplier_id` (`supplier_id`),
  ADD KEY `archived_by` (`archived_by`);
...
--
-- AUTO_INCREMENT for table `supplier_archives`
--
ALTER TABLE `supplier_archives`
  MODIFY `archive_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `inventory_history`
  ADD CONSTRAINT `fk_inventory_history_inventory` FOREIGN KEY (`inventory_id`) REFERENCES `branch_inventory` (`inventory_id`),
  ADD CONSTRAINT `fk_inventory_history_user` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`);
...
--
-- Constraints for table `supplier_archives`
--
ALTER TABLE `supplier_archives`
  ADD CONSTRAINT `supplier_archives_ibfk_1` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`supplier_id`),
  ADD CONSTRAINT `supplier_archives_ibfk_2` FOREIGN KEY (`archived_by`) REFERENCES `users` (`user_id`);
